/* L'Actu — French A-Level current-affairs comprehension
   Engine shared with La Actualidad; only this block differs.
*/
(function(){
"use strict";
/*CFG-START*/
const CFG={
  ...
  lex:"https://artmemry.github.io/A-Level-French-Edexcel-Vocab-training/",
  lexName:"Le Lexique"
};
/*CFG-END*/
/*T-START*/
const T={
  ...
  homeTitle:"L'actualité en français",
  homeLede:"Chaque numéro prend les histoires du mois qui touchent vraiment aux quatre thèmes de l'examen. Le texte est écrit pour vous — il n'est pas copié du journal — et le lien vers l'article d'origine est toujours donné. Tapez votre nom, faites les activités, puis téléchargez vos réponses pour votre professeur.",
  nameLabel:"Votre nom",
  namePh:"Prénom + initiale, ex. Sophie K.",
  issueLabel:"Numéro",
  themeLabel:"Thème",
  allThemes:"Tous",
  noItem:t=>"Rien ce mois-ci pour le thème "+t+" — l'actualité n'a rien donné qui vaille la peine.",
  emptyIssue:"Ce numéro est vide.",
  words:n=>n+" mots",
  minutes:n=>"≈ "+n+" min",
  read:"Lire et répondre",
  doneTag:(s,m)=>s+"/"+m,
  back:"← Retour aux articles",
  sourceLine:"D'après",
  sourceRead:"lire l'article d'origine ↗",
  adapted:"Texte écrit pour ce site d'après les faits publiés. Ce n'est pas l'article original.",
  glossaryShow:"Afficher le lexique",
  glossaryHide:"Masquer le lexique",
  lexLink:l=>"Réviser d'abord : "+l,
  tasksTitle:"Compréhension",
  stretchTitle:"Pour aller plus loin",
  stretchNote:"Pas de correction automatique : comparez votre réponse au modèle, puis gardez la vôtre dans le fichier à rendre.",
  showModel:"Voir une réponse modèle",
  hideModel:"Masquer le modèle",
  vf:["Vrai","Faux","Non mentionné"],
  vfLong:{V:"Vrai",F:"Faux",N:"Non mentionné"},
  check:"Vérifier",
  correct:"Correct.",
  wrong:"Non.",
  answerWas:a=>"Réponse : "+a,
  selfOk:"Ma version est aussi valable",
  selfDone:"Acceptée ✓",
  keysNote:"Il fallait ces idées : ",
  matchHint:"Cliquez un mot à gauche, puis sa traduction à droite.",
  bankLabel:"Mots proposés",
  scoreLabel:"Score",
  finish:"Terminer et télécharger",
  finishNote:"Le fichier contient vos réponses, votre score et votre nom. Envoyez-le à votre professeur ou déposez-le sur Teams.",
  needName:"Écrivez votre nom en haut de la page d'accueil avant de télécharger.",
  downloaded:"Fichier téléchargé.",
  fileHead:"L'ACTU — travail rendu",
  fileName:"Nom",
  fileDate:"Date",
  fileItem:"Article",
  fileTheme:"Thème",
  ...
  fileOk:"juste",
  fileNo:"faux",
  fileClaim:"(l'élève estime sa réponse juste aussi)",
  fileStretch:"Pour aller plus loin",
  fileNothing:"(rien écrit)",
  answersTitle:"Corrigé",
  answersLede:"Réservé au professeur — cette page n'est pas liée depuis le site.",
  none:"—"
};
/*T-END*/
/* ───────── data ───────── */
